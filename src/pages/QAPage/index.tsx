...
const GuideDocumentation: React.FC = () => {
  const guideItems: GuideItem[] = [
    ...
    },
    {
      id: 5,
      title: '游戏把网页覆盖了有问题吗？',
      content: `建议使用两个屏幕，游戏运行时网页移到另一个屏幕使用。因为当您将网页最小化或覆盖隐藏后，您与服务器的连接将会断开，无法将您的实时位置同步到其他玩家的地图，也无法接收其他玩家的位置和标记。
      <br/>如果您只有一个屏幕或需要隐藏网页，您需要打开<span class="info">画中画</span>功能保证与服务器的正常连接。如果您不需要看<span class="info">画中画</span>的内容，您可以将窗口可以拖到屏幕边缘，但请<span class="error">不要关闭窗口</span>。
    ...
    },
    {
      ...
      右键点击橡皮可以调整橡皮的大小，清除频道的线条、位置坐标信息。`,
    },
    {
      id: 7,
      title: '其他设置',
